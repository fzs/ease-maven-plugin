 ...
 * @see EaseAbstractStrictPatternArtifactFilter
 * @see PatternIncludesArtifactFilter
 */
public class EaseStrictPatternIncludesArtifactFilter extends EaseAbstractStrictPatternArtifactFilter
{
    /**
     ...
     */
    public EaseStrictPatternIncludesArtifactFilter( List<String> patterns )
    {
        super( patterns, true );
    }
}
