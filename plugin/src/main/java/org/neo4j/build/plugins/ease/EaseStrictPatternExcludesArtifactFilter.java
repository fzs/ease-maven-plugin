 ...
 */
public class EaseStrictPatternExcludesArtifactFilter extends EaseAbstractStrictPatternArtifactFilter
{
    /**
     ...
     */
    public EaseStrictPatternExcludesArtifactFilter( List<String> patterns )
    {
